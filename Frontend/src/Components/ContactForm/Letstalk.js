        ...
        <div className="container py-5">
            <div className="row">
                ...
                <div className="col-lg-8 col-md-12 col-sm-12">
                    <h4 className='font-face-im text-center red'>WE SERVED YOU AS YOU HAVE NEVER SERVED BEFORE</h4>
                    <p className='inner-Heading font-face-im text-center black'>OVER WHELMED WITH ALL THE OPTIONS FOR YOUR BRANDING SOLUTIONS</p>
                </div>
                <div className="col-md-2"></div>
            </div>
                    ...
                    <div className='MainInput'>
                        <div style={divStyle}>
                            ...
                            <span
                                ...
                                className='Span font-face-sm ms-3 text-white'>Subscribe Us</span>
