        ...
        <div className='Blog py-5 container-fluid'>
            <div className="row">
                ...
                <div className="col-md-8">
                    ...
                    <h2 className='font-face-im text-center text-white py-2'>OUR RECENT BLOGS & NEWS</h2>
                </div>
                <div className="col-md-2"></div>
            </div>
                            ...
                            {items.map((x, index) => {
                                return (
                                    <div className="col-lg-8">
                                        <div className='px-3'>
                                            <img className='Blog-img img-fluid' src={x.imageUrl} alt="1" />
                                            <div className="row">
                                                <div className='Icon-Box py-3'>
                                                    <div className='Icon-Box-inner'>
                                                        <img src={icon1} alt='icon1' className='img-fluid' />
                                                        <p className='my-title font-face-im text-white ms-2 mt-2'>{x.title}</p>
                                                    </div>
                                                    <div className='Icon-Box-inner ms-3'>
                                                        <img src={icon2} alt='icon1' className='img-fluid' />
                                                        <p className='date font-face-im text-white ms-2 mt-2'>{x.date}</p>
                                                    </div>
                                                </div>
                                                <h5 className='font-face-im Content-heading'>{x.heading}</h5>
                                                ...
                                                <div className="buttonView d-flex justify-content-start align-items-center">
                                                    <CustomButtonArrow
                                                        ...
                                                        title={x.buttonText} rf={x.route} rn='yes' />
                                                </div>
